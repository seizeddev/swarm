...
const KEYWORDS = new Set([
  "const", "let", "var", "function", "fn", "def", "class", "struct", "enum", "interface",
  "type", "impl", "trait", "pub", "use", "import", "from", "export", "default", "return",
  "if", "else", "elif", "for", "while", "loop", "match", "switch", "case", "break",
  "continue", "async", "await", "yield", "new", "this", "self", "super", "extends",
  "implements", "public", "private", "protected", "static", "final", "void", "int",
  "bool", "string", "true", "false", "null", "nil", "none", "None", "True", "False",
  "and", "or", "not", "in", "is", "as", "with", "try", "catch", "except", "finally",
  "throw", "raise", "where", "mut", "move", "ref", "go", "func", "package", "namespace",
]);
